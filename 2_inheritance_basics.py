...
class Beagle(Dog):
    """A class to represent a specific type dog"""

    def __init__(self, my_name, my_gender, my_age, is_gun_shy_boolean):
        #call the initialization of the super (parent) class
        super().__init__(my_name, my_gender,my_age)
        self.is_gun_shy = is_gun_shy_boolean
    ...
    def bark(self, is_loud):
        """Get the dog to speak"""
        if is_loud:
            print("HOWL HOWL HOWWWWWWWWWWLLLLLLLLLLLLL")
        else:
            print("howl")        
